...
var onboarding_controller_default = class extends Controller {
  static values = {
    currentStep: String
  };
  connect() {
...
// app/javascript/controllers/integration_setup_controller.js
var integration_setup_controller_default = class extends Controller {
  ...
  async testConnection(event) {
    ...
    try {
      ...
      console.error("Connection test error:", error2);
      resultContainer.innerHTML = `
        <div class="bg-red-50 border border-red-200 rounded-xl p-4">
          <div class="flex items-center">
            <svg class="w-5 h-5 text-red-600 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <h4 class="font-medium text-red-800">Connection Failed</h4>
              <p class="text-sm text-red-700">${error2.message}</p>
            </div>
          </div>
        </div>
      `;
...
var polling_controller_default = class extends Controller {
  static values = {
    interval: { type: Number, default: 3e4 },
    syncUrl: String
  };
  connect() {
    this.startPolling();
...
// app/javascript/controllers/sync_button_controller.js
var sync_button_controller_default = class extends Controller {
...
// app/javascript/controllers/github_settings_controller.js
var github_settings_controller_default = class extends Controller {
  static targets = ["accessToken", "owner", "repo", "defaultBranch", "result"];
  async testConnection(event) {
    const button = event.currentTarget;
    const resultContainer = document.getElementById("github-connection-result");
    const credentials = {
      access_token: this.accessTokenTarget.value,
      owner: this.ownerTarget.value,
      repo: this.repoTarget.value,
      default_branch: this.defaultBranchTarget.value || "main"
    };
    button.disabled = true;
    const originalContent = button.innerHTML;
    button.innerHTML = `
    ...
    `;
    try {
      const response = await fetch("/settings/test_github", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "X-CSRF-Token": document.querySelector("[name='csrf-token']").content,
        ...
        body: JSON.stringify({ github: credentials })
      });
      ...
      this.resultTarget.innerHTML = `
        <div class="flex items-center">
          ...
          <div>
            <span class="font-medium text-red-800">Connection Failed</span>
            <p class="text-red-700">${error2.message}</p>
          </div>
        </div>
      `;
    } finally {
...
// app/javascript/controllers/generate_pr_controller.js
var generate_pr_controller_default = class extends Controller {
...
// app/javascript/controllers/pr_auto_open_controller.js
var pr_auto_open_controller_default = class extends Controller {
...
application.register("onboarding", onboarding_controller_default);
application.register("integration-setup", integration_setup_controller_default);
application.register("polling", polling_controller_default);
application.register("sync-button", sync_button_controller_default);
application.register("github-settings", github_settings_controller_default);
application.register("generate-pr", generate_pr_controller_default);
application.register("pr-auto-open", pr_auto_open_controller_default);
...
@hotwired/turbo/dist/turbo.es2017-esm.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/application-4a41045f.js.map
