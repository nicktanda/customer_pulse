...
> **Archived 2026:** This document described the **pre-Next.js Rails 8** product plan and file layout. The shipping app is the TypeScript monorepo (`apps/web`, `apps/worker`, `packages/db`). Keep this file for historical reference only. **Location:** `docs/archive/plans/legacy-rails-project-plan.md` (moved from `docs/archive/PLAN.md`).
